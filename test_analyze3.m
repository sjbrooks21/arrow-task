...
save(strcat('all_stim_', string(datetime('today')), '_', num2str(stim_params.nSims), '.mat'), 'stim_params', 'stim', 'task')
...
save(strcat('all_model_data_', string(datetime('today')), '_', num2str(stim_params.nSims),'.mat'), 'all_model_data')
